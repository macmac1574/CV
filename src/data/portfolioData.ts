...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Full-featured e-commerce web app with cart management, Stripe payment integration, order tracking, and seller dashboard.',
    image: '',
    technologies: ['React', 'Node.js', 'MongoDB', 'Express', 'Stripe'],
    github: 'https://github.com/marksicad/shopease',
    demo: '#',
    category: 'Web',
    featured: true,
  },
  {
    ...
    description: 'Collaborative project management tool inspired by Trello. Supports drag-and-drop boards, team invites, and deadline tracking.',
    image: '',
    technologies: ['React', 'TypeScript', 'Firebase', 'Framer Motion'],
    github: 'https://github.com/marksicad/taskflow',
    demo: '#',
    category: 'Web',
  },
  {
    ...
    description: 'A comprehensive design system and React component library with 50+ accessible, customizable components documented with Storybook.',
    image: '',
    technologies: ['React', 'TypeScript', 'Storybook', 'Tailwind CSS'],
    github: 'https://github.com/marksicad/ui-lib',
    demo: '#',
    category: 'UI/UX',
  },
  {
    ...
    description: 'Real-time network monitoring dashboard for LAN environments. Visualizes traffic, connected devices, and anomaly alerts.',
    image: '',
    technologies: ['Python', 'React', 'WebSocket', 'Chart.js'],
    github: 'https://github.com/marksicad/netmonitor',
    demo: '#',
    category: 'Systems',
  },
  {
    ...
    description: 'Cross-platform study planner with flashcards, Pomodoro timer, progress tracking, and AI-generated quiz questions.',
    image: '',
    technologies: ['Flutter', 'Firebase', 'Dart', 'OpenAI API'],
    github: 'https://github.com/marksicad/studybuddy',
    demo: '#',
    category: 'Mobile',
  },
  {
    ...
    description: 'Interactive web platform for cybersecurity awareness training with gamified modules, quizzes, and certificate generation.',
    image: '',
    technologies: ['React', 'Node.js', 'MySQL', 'Chart.js'],
    github: 'https://github.com/marksicad/cybersec-platform',
    demo: '#',
    category: 'Research',
  },
]
...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description: [
      ...
      'Coordinated a team of 4 developers using Git and Agile methodology',
...
export const services: Service[] = [
  ...
  },
  {
    ...
    icon: 'Database',
    features: ['MySQL / MongoDB', 'Schema Design', 'Query Optimization', 'Data Migration'],
  },
  {
    id: 5,
